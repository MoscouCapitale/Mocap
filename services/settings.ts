...
const mainSettings = ('email_contact,email_user_creator,email_logging,email_administrator,email_default_sender,mail_pairing (id, email_recipient, email_sender),api_spotify,api_deezer,api_soundcloud,api_amazon_music,api_youtube_music,api_tidal,website_url,website_title,website_icone,website_keywords,website_language')
